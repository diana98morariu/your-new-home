...
<form id="signupForm" class="signupForm" method="POST">
    ...
    <button id="signup_button_agent" onclick="return signup(this);" data-start="SIGN UP AS AN AGENT" data-wait="WAIT ...">SIGN UP AS AN AGENT</button>
</form>
<!-- <div id="error_message_agent">
